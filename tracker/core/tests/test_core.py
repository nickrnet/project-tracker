...
class CoreModelManagerTestCase(TestCase):
    def setUp(self):
        ...
        self.user_to_hard_delete = CoreUser.objects.create_core_user_from_web({"email": "testuser_hard_deleted@test.com", "password": "password"})
        self.user_to_soft_delete = CoreUser.objects.create_core_user_from_web({"email": "testuser_soft_deleted@test.com", "password": "password"})
        self.user_to_not_delete = CoreUser.objects.create_core_user_from_web({"email": "testuser_not_deleted@test.com", "password": "password"})
    ...
    def test_get_deleted_items(self):
        deleted_items = CoreUser.get_deleted_items()
    ...
    def test_get_hard_deleted_items(self):
        hard_deleted_items = CoreUser.get_hard_deleted_items()
    ...
    def test_get_soft_deleted_items(self):
        soft_deleted_items = CoreUser.get_soft_deleted_items()
...
class CoreModelTestCase(TestCase):
    def setUp(self):
        self.system_user = CoreUser.objects.get_or_create_system_user()
        self.user_to_delete = CoreUser.objects.create_core_user_from_web({"email": "testuser@test.com", "password": "password"})
