    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
                ('archived', models.BooleanField(default=False)),
                ('type', models.CharField(choices=[('CHANGE_REQUEST', 'Change Request'), ('PROBLEM', 'Problem'), ('INCIDENT', 'Incident'), ('SERVICE_REQUEST', 'Service Request'), ('TEST', 'Test'), ('IMPROVEMENT', 'Improvement'), ('ENHANCEMENT', 'Enhancement'), ('QUESTION', 'Question'), ('PROPOSAL', 'Proposal'), ('SPIKE', 'Spike'), ('SUB_TASK', 'Sub-task'), ('TASK', 'Task'), ('FEATURE', 'Feature'), ('STORY', 'Story'), ('EPIC', 'Epic'), ('DOCUMENTATION', 'Documentation'), ('BUG', 'Bug')], max_length=255)),
                ('description', models.TextField(blank=True, default='', null=True)),
                ('created_by', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_created_by', to='core.coreuser')),
                ('deleted', models.ForeignKey(blank=True, db_index=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.deletedmodel')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_created_by', to='core.coreuser')),
                ('deleted', models.ForeignKey(blank=True, db_index=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.deletedmodel')),
                ('current', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='project.componentdata')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_created_by', to='core.coreuser')),
                ('deleted', models.ForeignKey(blank=True, db_index=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.deletedmodel')),
                ('current', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='project.customissueseveritydata')),
            ],
            options={
                'ordering': ['current__name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_created_by', to='core.coreuser')),
                ('deleted', models.ForeignKey(blank=True, db_index=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.deletedmodel')),
                ('current', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='project.gitrepositorydata')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_created_by', to='core.coreuser')),
                ('deleted', models.ForeignKey(blank=True, db_index=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.deletedmodel')),
                ('current', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='project.issuedata')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='project.project')),
            ],
            options={
                'ordering': ['-created_on'],
        ...
        migrations.AddField(
            ...
            name='current',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='project.projectlabeldata'),
        ),
        migrations.CreateModel(
            name='Version',
            fields=[
        ...
        migrations.AddField(
            model_name='version',
            name='current',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='project.versiondata'),
        ),
    ]
