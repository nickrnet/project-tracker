...
class TestProjectsView(TestCase):
    def setUp(self):
        ...
        self.project2 = Project.objects.create(created_by=self.user1, current=self.project2_data)
        self.project2_label = ProjectLabel.objects.create(created_by=self.user1, current=self.project2_label_data, project=self.project2)
