...
class TestIssuesView(TestCase):
    ...
    def test_issues_view_redirects_when_not_logged_in(self):
        response = self.http_client.get(reverse('issues'))
    ...
    def test_issues_view_get(self):
        ...
        self.assertTemplateUsed(response, 'project/issue/issues_template.html')
