...
class OrganizationDataForm(forms.Form):
    ...
    responsible_party_phone = forms.CharField(
        max_length=255, widget=forms.TextInput(attrs={'type': 'tel'}))
    ...
    timezone = forms.CharField(max_length=255, required=False,
                               initial=timezone.get_default_timezone_name())
    ...
    # TODO: Move these to the Organization form
